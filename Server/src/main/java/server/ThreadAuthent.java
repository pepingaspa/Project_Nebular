...
public class ThreadAuthent extends Thread{
    ...
    public void run(){
        ...
        try{
            ...
            System.out.println(Arrays.toString(NetworkInterface.getByInetAddress(socket.getInetAddress()).getHardwareAddress()));
            ...
            Entity ent = new Entity(threadClient, userLog, keyDef);
