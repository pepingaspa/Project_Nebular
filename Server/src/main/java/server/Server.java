...
public class Server extends javax.swing.JFrame {
    ...
    private static void envoieMail(String from,String pwd,String to,String sub,String msg){
        ...
        try {
            ...
            m.setSubject(sub);
            m.setText(msg);
            //ERROR : MAIL NEVER SEND - pb de co/mdp ?
            //Transport.send(m);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            envoieMail("pfenebular@gmail.com","Babiilabilux3","pfenebular@gmail.com","[NEBULAR] Code administrateur","Voici votre mot de passe nebular :");
            countDown();
        });
    }
